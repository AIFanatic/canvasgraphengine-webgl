...
export class Header extends Widget {
    ...
    constructor(x: number, y: number, title: string) {
        ...
        this.headerDivisor = new Rectangle(x, y + 15, 200, 1, Color.RGB(20, 20, 20));
        this.headerStatus = new Circle(x - 90, y, 5, Color.RGB(46, 204, 112));

        this.title = new Text(x - 30.0, y, title, 10, Color.RGB(145, 145, 145));

...
export class Slot extends Widget {
    ...
    public addInput(label: string) {
        ...
        const inputStatus = new Circle(this.x - 90, this.y, 4, Color.HEX(70, 70, 70));
        const inputLabel = new Text(this.x + labelLength - 60, this.y, label, 10, Color.HEX(145, 145, 145));
    ...
    public addOutput(label: string) {
        ...
        const outputStatus = new Circle(this.x + 90, this.y, 4, Color.HEX(70, 70, 70));
        const outputLabel = new Text(this.x - labelLength + 65, this.y, label, 10, Color.HEX(145, 145, 145));
